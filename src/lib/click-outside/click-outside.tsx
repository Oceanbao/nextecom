import React, { useRef, useEffect, MouseEvent, ReactElement, forwardRef, Ref } from 'react'
 ...
 */
const ClickOutside = forwardRef(({ active = true, onClick, children }: ClickOutsideProps, forwardedRef) => {
