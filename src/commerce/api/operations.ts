...
export type Operations<P extends APIProvider> = {
  login: {
    <T extends LoginOperation>(opts: { variables: T['variables']; config?: P['config']; res: ServerResponse }): Promise<
      T['data']
    >
  ...
  getAllPages: {
    <T extends GetAllPagesOperation>(opts?: { config?: P['config']; preview?: boolean }): Promise<T['data']>
  ...
  getPage: {
    <T extends GetPageOperation>(opts: { variables: T['variables']; config?: P['config']; preview?: boolean }): Promise<
      T['data']
    >
  ...
  getSiteInfo: {
    <T extends GetSiteInfoOperation>(opts: { config?: P['config']; preview?: boolean }): Promise<T['data']>
  ...
  getAllProductPaths: {
    <T extends GetAllProductPathsOperation>(opts: { variables?: T['variables']; config?: P['config'] }): Promise<
      T['data']
    >
