...
export type HookFetcherContext<H extends HookSchemaBase> = {
  ...
  fetch: <T = H['fetchData'] extends {} | null ? H['fetchData'] : any, B = H['body']>(
...
export type HookFunction<Input extends { [k: string]: unknown } | undefined, T> = keyof Input extends never
  ? () => T
