...
import { Button, Text, Rating, Collapse } from '@components/base'
...
const ProductSidebar: FC<ProductSidebarProps> = ({ product, className }) => {
  ...
  return (
    <div className={className}>
      ...
      />
      <Text className="pb-4 break-words w-full max-w-xl" html={product.descriptionHtml || product.description} />
